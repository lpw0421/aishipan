...
const saveProfile = async () => {
  ...
  if (profile.username === user.username && profile.name === user.name) {
  ...
  try {
    ...
    ElMessage.success('个人信息已保存，即将返回首页')
...
.page-header h2 { margin: 0; color: #1a1a2e; }
