...
const ALLOWED_COMMANDS = {
  ...
  'sync-client': 'cd /opt/aishipan/client && echo "[sync-client] 创建目录..." && mkdir -p src/views/raw-material src/views/system src/views/pest src/views/calibration src/views/hr src/views/training src/views/ai-audit src/router && echo "[sync-client] 下载文件..." && for f in src/router/index.js src/views/MainLayout.vue src/views/ChatBot.vue src/views/raw-material/Library.vue src/views/raw-material/ProductStandards.vue src/views/raw-material/NonConforming.vue src/views/raw-material/Samples.vue src/views/raw-material/StandardChanges.vue src/views/raw-material/ComplaintWrapper.vue src/views/system/SystemDocs.vue src/views/system/SystemWrapper.vue src/views/pest/PestWrapper.vue src/views/calibration/CalibrationWrapper.vue src/views/hr/Personnel.vue src/views/hr/PersonnelWrapper.vue src/views/hr/ThirdParty.vue src/views/training/TrainingWrapper.vue src/views/ai-audit/LabelWrapper.vue src/views/ai-audit/ComplaintReport.vue src/views/ai-audit/SupplierAudit.vue src/views/ai-audit/MaterialInspection.vue src/views/ai-audit/DocumentHelper.vue src/views/ai-audit/SopHelper.vue src/views/ai-audit/ExamHelper.vue src/views/ai-audit/RegulationHelper.vue src/views/ai-audit/HaccpHelper.vue; do curl -sS --connect-timeout 10 --max-time 30 https://raw.githubusercontent.com/lpw0421/aishipan/master/client/$f -o $f && echo "  OK: $f" || echo "  FAIL: $f"; done && echo "[sync-client] 构建..." && npm run build 2>&1 && nginx -s reload && echo SYNC_CLIENT_OK',
