...
const ALLOWED_COMMANDS = {
  ...
  'deploy-update': 'cp /opt/aishipan/server/uploads/1781021119834-483041331.pdf /tmp/update.tar.gz && tar xzf /tmp/update.tar.gz -C /opt/aishipan/ && pm2 restart aishipan && echo DEPLOY_OK',
